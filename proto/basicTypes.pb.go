...
var file_basicTypes_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x2f, 0x50, 0x72, 0x6f,
	0x37, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_basicTypes_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_basicTypes_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_basicTypes_proto_goTypes = []interface{}{
	...
	(*URLs)(nil),                     // 5: rv.data.URLs
	(*UUID)(nil),                     // 6: rv.data.UUID
	(*IntRange)(nil),                 // 7: rv.data.IntRange
	(*Color)(nil),                    // 8: rv.data.Color
	(*Version)(nil),                  // 9: rv.data.Version
	(*ApplicationInfo)(nil),          // 10: rv.data.ApplicationInfo
	(*CollectionElementType)(nil),    // 11: rv.data.CollectionElementType
	(*URL_LocalRelativePath)(nil),    // 12: rv.data.URL.LocalRelativePath
	(*URL_ExternalRelativePath)(nil), // 13: rv.data.URL.ExternalRelativePath
	(*URL_ExternalRelativePath_MacOSExternalVolume)(nil), // 14: rv.data.URL.ExternalRelativePath.MacOSExternalVolume
	(*URL_ExternalRelativePath_Win32ExternalVolume)(nil), // 15: rv.data.URL.ExternalRelativePath.Win32ExternalVolume
}
var file_basicTypes_proto_depIdxs = []int32{
	0,  // 0: rv.data.URL.platform:type_name -> rv.data.URL.Platform
	12, // 1: rv.data.URL.local:type_name -> rv.data.URL.LocalRelativePath
	13, // 2: rv.data.URL.external:type_name -> rv.data.URL.ExternalRelativePath
	4,  // 3: rv.data.URLs.urls:type_name -> rv.data.URL
	2,  // 4: rv.data.ApplicationInfo.platform:type_name -> rv.data.ApplicationInfo.Platform
	9,  // 5: rv.data.ApplicationInfo.platform_version:type_name -> rv.data.Version
	3,  // 6: rv.data.ApplicationInfo.application:type_name -> rv.data.ApplicationInfo.Application
	9,  // 7: rv.data.ApplicationInfo.application_version:type_name -> rv.data.Version
	6,  // 8: rv.data.CollectionElementType.parameter_uuid:type_name -> rv.data.UUID
	1,  // 9: rv.data.URL.LocalRelativePath.root:type_name -> rv.data.URL.LocalRelativePath.Root
	14, // 10: rv.data.URL.ExternalRelativePath.macos:type_name -> rv.data.URL.ExternalRelativePath.MacOSExternalVolume
	15, // 11: rv.data.URL.ExternalRelativePath.win32:type_name -> rv.data.URL.ExternalRelativePath.Win32ExternalVolume
