...
var file_proCore_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x42, 0x0f, 0x5a,
	0x0d, 0x2f, 0x50, 0x72, 0x6f, 0x37, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x62, 0x06,
...
var file_proCore_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_proCore_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_proCore_proto_goTypes = []interface{}{
	...
	(*MediaMetadataRequestInfo)(nil),                                      // 6: rv.data.MediaMetadataRequestInfo
	(*MediaMetadataRequestResponse)(nil),                                  // 7: rv.data.MediaMetadataRequestResponse
	(*TriggerOptions)(nil),                                                // 8: rv.data.TriggerOptions
	(*ControlTransport)(nil),                                              // 9: rv.data.ControlTransport
	(*AudioInputSettings)(nil),                                            // 10: rv.data.AudioInputSettings
	(*VideoInputSettings)(nil),                                            // 11: rv.data.VideoInputSettings
	(*RecordRequest)(nil),                                                 // 12: rv.data.RecordRequest
	(*TextSegmentRequest)(nil),                                            // 13: rv.data.TextSegmentRequest
	(*MediaMetadataRequestResponse_Metadata)(nil),                         // 14: rv.data.MediaMetadataRequestResponse.Metadata
	(*MediaMetadataRequestResponse_BitmapInfo)(nil),                       // 15: rv.data.MediaMetadataRequestResponse.BitmapInfo
	(*ControlTransport_PlayControlType)(nil),                              // 16: rv.data.ControlTransport.PlayControlType
	(*ControlTransport_PauseControlType)(nil),                             // 17: rv.data.ControlTransport.PauseControlType
	(*ControlTransport_RewindControlType)(nil),                            // 18: rv.data.ControlTransport.RewindControlType
	(*ControlTransport_FastForwardControlType)(nil),                       // 19: rv.data.ControlTransport.FastForwardControlType
	(*ControlTransport_SkipBackControlType)(nil),                          // 20: rv.data.ControlTransport.SkipBackControlType
	(*ControlTransport_SkipForwardControlType)(nil),                       // 21: rv.data.ControlTransport.SkipForwardControlType
	(*ControlTransport_StepBackControlType)(nil),                          // 22: rv.data.ControlTransport.StepBackControlType
	(*ControlTransport_StepForwardControlType)(nil),                       // 23: rv.data.ControlTransport.StepForwardControlType
	(*ControlTransport_GoToStartControlType)(nil),                         // 24: rv.data.ControlTransport.GoToStartControlType
	(*ControlTransport_GoToEndControlType)(nil),                           // 25: rv.data.ControlTransport.GoToEndControlType
	(*ControlTransport_JumpToTimeControlType)(nil),                        // 26: rv.data.ControlTransport.JumpToTimeControlType
	(*ControlTransport_JumpToPercentControlType)(nil),                     // 27: rv.data.ControlTransport.JumpToPercentControlType
	(*ControlTransport_MarkInPointControlType)(nil),                       // 28: rv.data.ControlTransport.MarkInPointControlType
	(*ControlTransport_MarkOutPointControlType)(nil),                      // 29: rv.data.ControlTransport.MarkOutPointControlType
	(*ControlTransport_SetScaleModeControlType)(nil),                      // 30: rv.data.ControlTransport.SetScaleModeControlType
	(*ControlTransport_SetFlippedModeControlType)(nil),                    // 31: rv.data.ControlTransport.SetFlippedModeControlType
	(*ControlTransport_SetPlayRateControlType)(nil),                       // 32: rv.data.ControlTransport.SetPlayRateControlType
	(*ControlTransport_SetNativeRotationControlType)(nil),                 // 33: rv.data.ControlTransport.SetNativeRotationControlType
	(*ControlTransport_TogglePlaybackControlType)(nil),                    // 34: rv.data.ControlTransport.TogglePlaybackControlType
	(*ControlTransport_SetEffectsControlType)(nil),                        // 35: rv.data.ControlTransport.SetEffectsControlType
	(*ControlTransport_UpdateEffectControlType)(nil),                      // 36: rv.data.ControlTransport.UpdateEffectControlType
	(*ControlTransport_BeginScrubControlType)(nil),                        // 37: rv.data.ControlTransport.BeginScrubControlType
	(*ControlTransport_EndScrubControlType)(nil),                          // 38: rv.data.ControlTransport.EndScrubControlType
	(*ControlTransport_ScrubToTimeControlType)(nil),                       // 39: rv.data.ControlTransport.ScrubToTimeControlType
	(*ControlTransport_ScrubToPercentControlType)(nil),                    // 40: rv.data.ControlTransport.ScrubToPercentControlType
	(*ControlTransport_SetAudioFadeType)(nil),                             // 41: rv.data.ControlTransport.SetAudioFadeType
	(*ControlTransport_SetAudioPropertiesType)(nil),                       // 42: rv.data.ControlTransport.SetAudioPropertiesType
	(*RecordRequest_Resi)(nil),                                            // 43: rv.data.RecordRequest.Resi
	(*TextSegmentRequest_Segment)(nil),                                    // 44: rv.data.TextSegmentRequest.Segment
	(*Effect)(nil),                                                        // 45: rv.data.Effect
	(*Graphics_EdgeInsets)(nil),                                           // 46: rv.data.Graphics.EdgeInsets
	(*AudioInput)(nil),                                                    // 47: rv.data.AudioInput
	(*VideoInput)(nil),                                                    // 48: rv.data.VideoInput
	(*Recording_Stream)(nil),                                              // 49: rv.data.Recording.Stream
	(*URL)(nil),                                                           // 50: rv.data.URL
	(*Media_AudioProperties)(nil),                                         // 51: rv.data.Media.AudioProperties
}
var file_proCore_proto_depIdxs = []int32{
	45, // 0: rv.data.MediaMetadataRequestInfo.effects:type_name -> rv.data.Effect
	46, // 1: rv.data.MediaMetadataRequestInfo.crop_insets:type_name -> rv.data.Graphics.EdgeInsets
	0,  // 2: rv.data.MediaMetadataRequestInfo.native_rotation:type_name -> rv.data.MediaMetadataRequestInfo.NativeRotationType
	14, // 3: rv.data.MediaMetadataRequestResponse.metadata:type_name -> rv.data.MediaMetadataRequestResponse.Metadata
	15, // 4: rv.data.MediaMetadataRequestResponse.generated_bitmap_info:type_name -> rv.data.MediaMetadataRequestResponse.BitmapInfo
	2,  // 5: rv.data.TriggerOptions.content_destination:type_name -> rv.data.TriggerOptions.ContentDestination
	16, // 6: rv.data.ControlTransport.play:type_name -> rv.data.ControlTransport.PlayControlType
	17, // 7: rv.data.ControlTransport.pause:type_name -> rv.data.ControlTransport.PauseControlType
	18, // 8: rv.data.ControlTransport.rewind:type_name -> rv.data.ControlTransport.RewindControlType
	19, // 9: rv.data.ControlTransport.fastforward:type_name -> rv.data.ControlTransport.FastForwardControlType
	20, // 10: rv.data.ControlTransport.skip_back:type_name -> rv.data.ControlTransport.SkipBackControlType
	21, // 11: rv.data.ControlTransport.skip_forward:type_name -> rv.data.ControlTransport.SkipForwardControlType
	22, // 12: rv.data.ControlTransport.step_back:type_name -> rv.data.ControlTransport.StepBackControlType
	23, // 13: rv.data.ControlTransport.step_forward:type_name -> rv.data.ControlTransport.StepForwardControlType
	24, // 14: rv.data.ControlTransport.go_to_start:type_name -> rv.data.ControlTransport.GoToStartControlType
	25, // 15: rv.data.ControlTransport.go_to_end:type_name -> rv.data.ControlTransport.GoToEndControlType
	26, // 16: rv.data.ControlTransport.jump_to_time:type_name -> rv.data.ControlTransport.JumpToTimeControlType
	27, // 17: rv.data.ControlTransport.jump_to_percent:type_name -> rv.data.ControlTransport.JumpToPercentControlType
	28, // 18: rv.data.ControlTransport.mark_in:type_name -> rv.data.ControlTransport.MarkInPointControlType
	29, // 19: rv.data.ControlTransport.mark_out:type_name -> rv.data.ControlTransport.MarkOutPointControlType
	30, // 20: rv.data.ControlTransport.set_scale_mode:type_name -> rv.data.ControlTransport.SetScaleModeControlType
	31, // 21: rv.data.ControlTransport.set_flipped_mode:type_name -> rv.data.ControlTransport.SetFlippedModeControlType
	32, // 22: rv.data.ControlTransport.set_play_rate:type_name -> rv.data.ControlTransport.SetPlayRateControlType
	33, // 23: rv.data.ControlTransport.set_rotation:type_name -> rv.data.ControlTransport.SetNativeRotationControlType
	34, // 24: rv.data.ControlTransport.toggle_playback:type_name -> rv.data.ControlTransport.TogglePlaybackControlType
	35, // 25: rv.data.ControlTransport.set_effects:type_name -> rv.data.ControlTransport.SetEffectsControlType
	36, // 26: rv.data.ControlTransport.update_effect:type_name -> rv.data.ControlTransport.UpdateEffectControlType
	37, // 27: rv.data.ControlTransport.begin_scrub:type_name -> rv.data.ControlTransport.BeginScrubControlType
	38, // 28: rv.data.ControlTransport.end_scrub:type_name -> rv.data.ControlTransport.EndScrubControlType
	39, // 29: rv.data.ControlTransport.scrub_to_time:type_name -> rv.data.ControlTransport.ScrubToTimeControlType
	40, // 30: rv.data.ControlTransport.scrub_to_percent:type_name -> rv.data.ControlTransport.ScrubToPercentControlType
	41, // 31: rv.data.ControlTransport.set_audio_fade:type_name -> rv.data.ControlTransport.SetAudioFadeType
	42, // 32: rv.data.ControlTransport.set_audio_properties:type_name -> rv.data.ControlTransport.SetAudioPropertiesType
	47, // 33: rv.data.AudioInputSettings.inputs:type_name -> rv.data.AudioInput
	48, // 34: rv.data.VideoInputSettings.inputs:type_name -> rv.data.VideoInput
	49, // 35: rv.data.RecordRequest.stream:type_name -> rv.data.Recording.Stream
	50, // 36: rv.data.RecordRequest.working_directory:type_name -> rv.data.URL
	43, // 37: rv.data.RecordRequest.resi:type_name -> rv.data.RecordRequest.Resi
	44, // 38: rv.data.TextSegmentRequest.segments:type_name -> rv.data.TextSegmentRequest.Segment
	1,  // 39: rv.data.MediaMetadataRequestResponse.Metadata.content_type:type_name -> rv.data.MediaMetadataRequestResponse.Metadata.ContentType
	3,  // 40: rv.data.ControlTransport.SetScaleModeControlType.mode:type_name -> rv.data.ControlTransport.SetScaleModeControlType.ScaleBehavior
	4,  // 41: rv.data.ControlTransport.SetScaleModeControlType.alignment:type_name -> rv.data.ControlTransport.SetScaleModeControlType.ScaleAlignment
	5,  // 42: rv.data.ControlTransport.SetNativeRotationControlType.rotation:type_name -> rv.data.ControlTransport.SetNativeRotationControlType.NativeRotationType
	45, // 43: rv.data.ControlTransport.SetEffectsControlType.effects:type_name -> rv.data.Effect
	45, // 44: rv.data.ControlTransport.UpdateEffectControlType.effect:type_name -> rv.data.Effect
	51, // 45: rv.data.ControlTransport.SetAudioPropertiesType.audio_properties:type_name -> rv.data.Media.AudioProperties
